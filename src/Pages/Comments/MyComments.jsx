              ...
              <div className="comment_cards">
                {myComment.map((data, index) => {
                  return (
                    <div
                      key={index}
                      className="card w-full px-[4%] border border-gray-300 lg:flex justify-between items-center "
                    >
                      <div className="comment_info">
                        <h2 className="text-lg capitalize font-semibold mt-2 mb-3  md:flex items-center gap-x-2">
                          {" "}
                          <FaDotCircle className="text-[10px] hidden md:block"></FaDotCircle>{" "}
                          {data.roadmapItemTitle} -{" "}
                          <span className="text-gray-600">
                            {" "}
                            By {data?.roadmapAuthor}{" "}
                          </span>{" "}
                        </h2>

                        <p className=" text-base capitalize font-semibold my-4">
                          My Comment :{" "}
                      ...
                      <div className="comment_action_btn flex justify-end lg:justify-start gap-x-8 text-2xl">
                        {/* edit */}
                        <div
                          className="edit p-2  cursor-pointer text-[#FF0070]  "
                          title="edit comment"
                        ...
                        {/* delete  */}
                        <div
                          className="delete p-2  cursor-pointer text-red-500  "
